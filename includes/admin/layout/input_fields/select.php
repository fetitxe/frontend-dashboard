				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<b><?php esc_attr_e('Select / Dropdown', 'frontend-dashboard'); ?></b>
						</h3>
					</div>
					<div class="panel-body">
						<div class="fed_input_text">
							...
							<div class="row fed_key_value_paid">
								<div class="col-md-5">
									<label for=""><?php esc_attr_e('Values', 'frontend-dashboard'); ?></label>
									<?php echo fed_input_box(
										'input_value',
										array(
								...
								<div class="col-md-7">
									<div class="row fed_key_value_eg_container">
										<div class="col-md-12">
											<label for=""><?php esc_attr_e('Examples:', 'frontend-dashboard'); ?></label>
											<p>key,value|one,One|two,Two|five-category,Five Category</p>
										</div>
										<div class="col-md-12">
											<b><?php esc_attr_e('This will be output as', 'frontend-dashboard'); ?></b>
											<br><br>
											<?php
											$value = array(
												'key'           => 'Value',
											...
											echo fed_input_box('fed_dummy_radio',array(
												'options' => $value
											), 'select');
										?></div>
									</div>
