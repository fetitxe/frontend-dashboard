				...
				'fed_default_admin_scripts_styles', array(
					'scripts' => array(
						...
						'fed_fontawesome-shims' => array(
							...
							'plugin_name'  => 'Frontend Dashboard',
							'src'          => plugins_url('/assets/frontend/js/fontawesome-shims.js', BC_FED_PLUGIN ),
							'dependencies' => array(),
							'version'      => false,
							'in_footer'    => true,
						),
...
//							'src'          => plugins_url( '/assets/frontend/js/flatpickr.js', BC_FED_PLUGIN ),
					...
					'styles'  => array(
						...
						'fed_admin_font_awesome-shims' => array(
							...
							'plugin_name'  => 'Frontend Dashboard',
							'src'          => plugins_url('/assets/frontend/css/fontawesome-shims.css', BC_FED_PLUGIN),
							'dependencies' => array(),
							'version'      => BC_FED_PLUGIN_VERSION,
							'media'        => 'all',
						),
				...
				//			'src'          => plugins_url('/assets/frontend/css/flatpickr.css', BC_FED_PLUGIN ),
						...
						'fed_global_admin_style'       => array(
							...
							'name'         => 'FED Global',
							'plugin_name'  => 'Frontend Dashboard',
							'src'          => plugins_url('/assets/admin/css/fed_global_admin_style.css', BC_FED_PLUGIN),
							'dependencies' => array(),
							'version'      => BC_FED_PLUGIN_VERSION,
							'media'        => 'all',
						),
