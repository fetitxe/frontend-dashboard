                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <b><?php esc_attr_e('Sort Dashboard Menu', 'frontend-dashboard'); ?></b>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="post"
                          ...
                          action="<?php echo esc_url( admin_url( 'admin-ajax.php?action=fed_admin_setting_form_dashboard_menu' ) ); ?>">
                ...
                <div class="panel-body">
                    <div class="fed_dashboard_menu_items_container">
                        ...
                        <div class="panel-group"
								data-url="<?php echo esc_url( admin_url( 'admin-ajax.php?action=fed_admin_menu_sorting&table=fed_menu&fed_nonce=' . wp_create_nonce( 'fed_nonce' ) ) ); ?>"
                            ...
                            foreach ($menus as $index => $menu) {
                                ...
                                $collapse++;
                                ?>
                                <div class="fed_dashboard_menu_single_item ui-state-default <?php echo esc_attr( $menu['menu'] ); ?>"
									...
									<div class="panel panel-secondary-heading">
										...
										">
                                            <h4 class="panel-title">
                                                <a>
													<?php
													echo '<span class="' . esc_attr( $menu['menu_image_id'] ) . '"></span>';
													?>
                                                                    ...
                                                                    <div class="col-md-2 hide">
                                                                        <div class="form-group">
																			...
																			<input type="number"
																					name="fed_menu_order"
																					class="form-control fed_menu_order"
																					value="<?php echo esc_attr($menu['menu_order']); ?>"
																					required="required"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-12 padd_top_10">
                                                                    <div class="col-md-2">
                                                                        <label><?php esc_attr_e( 'Select User Role(s)','frontend-dashboard'); ?></label>
                                                                    </div>
                                                                    <?php
                                                                    foreach ($user_roles as $key => $user_role) {
...
function fed_get_dashboard_menu_items_sort(){
    wp_enqueue_script('fed_menu_sort', plugins_url('assets/admin/js/fed_menu_sort.js', BC_FED_PLUGIN), array('jquery'));
		...
		foreach ( $new_menus as $new_menu ) {
            ...
            <li class="root_menu <?php echo esc_attr( $is_open ) . ' ' . esc_attr( $menu_type ); ?>"
				...
				<div>
					...
					<span class="fed_float_right">#<?php echo esc_attr(str_replace('_', ' ', ucwords( $menu_type, '_' ))); ?></span>
				</div>
                <?php if( $is_submenu ){
                    ...
                    <ul class="submenu">
						...
						foreach ( $submenu as $new_submenu ) {
							?>
							<li id="<?php echo esc_attr( $new_submenu['menu_type'] ) . '_' . esc_attr( $new_submenu['id'] ); ?>"
