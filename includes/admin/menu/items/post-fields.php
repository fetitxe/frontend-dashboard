            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="fed_UP_page_header">
                        <h3 class="fed_header_font_color"><?php esc_attr_e( 'Post Fields', 'frontend-dashboard'); ?></h3>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="row fed_alert_danger">
                    <div class="col-md-12">
                        <div class="alert alert-danger">
                            ...
                            <strong>
								<?php esc_attr_e( 'Sorry! there are no custom post fields added!', 'frontend-dashboard' ); ?>
                            </strong>
                        </div>
                    </div>
                </div>
