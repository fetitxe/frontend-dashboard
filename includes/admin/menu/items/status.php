                            ...
                            <div class="row">
                                <div class="col-md-6">
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td class="fed_header_font_color"><?php esc_attr_e( 'Settings', 'frontend-dashboard' ); ?></td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><?php esc_attr_e('Versions', 'frontend-dashboard'); ?></h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo esc_attr( fed_plugin_versions() ); ?></td>
                                                        </tr>
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead>
                                                        <tr>
                                                            <th><?php esc_attr_e('Name', 'frontend-dashboard'); ?></th>
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><?php esc_attr_e('PHP Extensions', 'frontend-dashboard') ?></h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><?php esc_attr_e('Database', 'frontend-dashboard') ?></h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <?php foreach (fed_get_table_status() as $table) { ?>
                                                            <tr>
                                                                <td class="fed_header_font_color"><?php echo esc_attr($table['title']) . ' ( ' . esc_attr($table['plugin_name']) . ' )'; ?></td>
                            ...
                            <div class="row">
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead>
                                                        <tr>
                                                            <th><?php esc_attr_e('Table Name', 'frontend-dashboard'); ?></th>
                                                            <th><?php esc_attr_e('Action', 'frontend-dashboard'); ?></th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><?php esc_attr_e('Empty The Table', 'frontend-dashboard') ?></h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="text-right">
                                                        <form method="post" class="fed_ajax"
                                                            ...
                                                            <button type="submit" class="fed_is_delete btn btn-danger"><i class="fa fa-trash"></i> <?php esc_attr_e('Delete all Options', 'frontend-dashboard'); ?></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
