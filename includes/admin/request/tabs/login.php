...
function fed_admin_setting_login_request(){
    ...
    if (isset($requests['fed_admin_unique_login']) && 'fed_login_settings' === $requests['fed_admin_unique_login']) {
        ...
        $message                     = __('Login ', 'frontend-dashboard');
    }
    ...
    if (isset($requests['fed_admin_unique_login']) && 'fed_register_settings' === $requests['fed_admin_unique_login']) {
        ...
        $message                     = __('Register ', 'frontend-dashboard');
    }
    if (isset($requests['fed_admin_unique_login']) && 'fed_wp_restrict_settings' === $requests['fed_admin_unique_login']) {
        ...
        $message                        = __('Restrict WP Admin ', 'frontend-dashboard');
    }
    ...
    if (isset($requests['fed_admin_unique_login']) && 'fed_restrict_username' === $requests['fed_admin_unique_login']) {
        ...
        $message                        = __('Restrict Username ', 'frontend-dashboard');
    }
...
function fed_restrict_admin_area(){
	...
	if( $restrict_admin_area
		 && $current_user_role 
		 && !( defined('DOING_AJAX') && DOING_AJAX ) 
		 && isset( $restrict_admin_area['restrict_wp']['role'] ) 
		 && array_key_exists($current_user_role, $restrict_admin_area['restrict_wp']['role']) 
		 && is_admin() 
	 ){
