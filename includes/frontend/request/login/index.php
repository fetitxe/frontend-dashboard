...
function fed_wp_ajax_fed_login_form_post() {
	...
	if( isset($post_payload['submit']) ){
		if( 'login' === $post_payload['submit'] || 'Login' === $post_payload['submit'] ){
			fed_login_form_submit( $post_payload );
		}elseif( 'register' === $post_payload['submit'] || 'Register' === $post_payload['submit'] ){
			fed_register_form_submit( $post_payload );
		}elseif( 'forgot_password' === $post_payload['submit'] || 'Forgot Password' === $post_payload['submit'] ){
			fed_forgot_form_submit( $post_payload );
		}elseif( 'reset_password' === $post_payload['submit'] || 'Reset Password' === $post_payload['submit'] ){
